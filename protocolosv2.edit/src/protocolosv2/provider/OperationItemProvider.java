...
/**
 * This is the item provider adapter for a {@link protocolosv2.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider extends OperandItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_Operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_Operator_feature", "_UI_Operation_type"),
				 Protocolosv2Package.Literals.OPERATION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Protocolosv2Package.Literals.OPERATION__OPERAND);
		}
	...
	public String getText(Object object) {
		Operador labelValue = ((Operation)object).getOperator();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Protocolosv2Package.Literals.OPERATION__OPERAND,
