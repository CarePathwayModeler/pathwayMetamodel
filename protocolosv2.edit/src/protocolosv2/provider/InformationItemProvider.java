...
/**
 * This is the item provider adapter for a {@link protocolosv2.Information} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InformationItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Information_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Information_text_feature", "_UI_Information_type"),
				 Protocolosv2Package.Literals.INFORMATION__TEXT,
				 true,
				 false,
				 false,
