...
/**
 * This is the item provider adapter for a {@link protocolosv2.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Protocolosv2Package.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addQuestionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_question_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_question_feature", "_UI_Category_type"),
				 Protocolosv2Package.Literals.CATEGORY__QUESTION,
				 true,
				 false,
				 true,
				 null,
