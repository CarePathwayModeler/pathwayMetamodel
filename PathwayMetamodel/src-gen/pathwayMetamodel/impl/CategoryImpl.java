 ...
 * </p>
 * <ul>
 *   <li>{@link pathwayMetamodel.impl.CategoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link pathwayMetamodel.impl.CategoryImpl#getQuestion <em>Question</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	protected EClass eStaticClass() {
		return PathwayMetamodelPackage.Literals.CATEGORY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathwayMetamodelPackage.CATEGORY__NAME, oldName,
					name));
	}
	...
	public EList<Question> getQuestion() {
		if (question == null) {
			question = new EObjectWithInverseResolvingEList<Question>(Question.class, this,
					PathwayMetamodelPackage.CATEGORY__QUESTION, PathwayMetamodelPackage.QUESTION__CATEGORY);
		}
		return question;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PathwayMetamodelPackage.CATEGORY__QUESTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PathwayMetamodelPackage.CATEGORY__NAME:
			return getName();
		case PathwayMetamodelPackage.CATEGORY__QUESTION:
			return getQuestion();
		}
