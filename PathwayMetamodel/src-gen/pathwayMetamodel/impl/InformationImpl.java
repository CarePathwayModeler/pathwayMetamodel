 ...
 * </p>
 * <ul>
 *   <li>{@link pathwayMetamodel.impl.InformationImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InformationImpl extends ElementImpl implements Information {
	...
	protected EClass eStaticClass() {
		return PathwayMetamodelPackage.Literals.INFORMATION;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathwayMetamodelPackage.INFORMATION__TEXT, oldText,
					text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PathwayMetamodelPackage.INFORMATION__TEXT:
			return getText();
		}
