 ...
 * </p>
 * <ul>
 *   <li>{@link pathwayMetamodel.impl.AuxiliaryConductImpl#getQuestions <em>Questions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuxiliaryConductImpl extends ElementImpl implements AuxiliaryConduct {
	...
	protected EClass eStaticClass() {
		return PathwayMetamodelPackage.Literals.AUXILIARY_CONDUCT;
	}
	...
	public EList<Question> getQuestions() {
		if (questions == null) {
			questions = new EObjectContainmentEList<Question>(Question.class, this,
					PathwayMetamodelPackage.AUXILIARY_CONDUCT__QUESTIONS);
		}
		return questions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PathwayMetamodelPackage.AUXILIARY_CONDUCT__QUESTIONS:
