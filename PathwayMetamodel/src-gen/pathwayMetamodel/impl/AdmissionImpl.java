 ...
 * </p>
 * <ul>
 *   <li>{@link pathwayMetamodel.impl.AdmissionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link pathwayMetamodel.impl.AdmissionImpl#getAdmission <em>Admission</em>}</li>
 *   <li>{@link pathwayMetamodel.impl.AdmissionImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link pathwayMetamodel.impl.AdmissionImpl#getClinical_indication <em>Clinical indication</em>}</li>
 *   <li>{@link pathwayMetamodel.impl.AdmissionImpl#getQuantity <em>Quantity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdmissionImpl extends MinimalEObjectImpl.Container implements Admission {
	...
	protected EClass eStaticClass() {
		return PathwayMetamodelPackage.Literals.ADMISSION;
	}
	...
	public void setUrl(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathwayMetamodelPackage.ADMISSION__URL, oldUrl, url));
	}
	...
	public void setAdmission(String newAdmission) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathwayMetamodelPackage.ADMISSION__ADMISSION,
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathwayMetamodelPackage.ADMISSION__REASON, oldReason,
					reason));
	}
	...
	public void setClinical_indication(String newClinical_indication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PathwayMetamodelPackage.ADMISSION__CLINICAL_INDICATION, oldClinical_indication,
					clinical_indication));
	}
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathwayMetamodelPackage.ADMISSION__QUANTITY,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PathwayMetamodelPackage.ADMISSION__URL:
			return getUrl();
		case PathwayMetamodelPackage.ADMISSION__ADMISSION:
			return getAdmission();
		case PathwayMetamodelPackage.ADMISSION__REASON:
			return getReason();
		case PathwayMetamodelPackage.ADMISSION__CLINICAL_INDICATION:
			return getClinical_indication();
		case PathwayMetamodelPackage.ADMISSION__QUANTITY:
			return getQuantity();
		}
