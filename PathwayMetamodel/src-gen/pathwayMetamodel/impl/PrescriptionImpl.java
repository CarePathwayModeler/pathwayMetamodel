 ...
 * </p>
 * <ul>
 *   <li>{@link pathwayMetamodel.impl.PrescriptionImpl#getMedication <em>Medication</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrescriptionImpl extends ElementImpl implements Prescription {
	...
	public EList<Medication> getMedication() {
		if (medication == null) {
			medication = new EObjectContainmentEList<Medication>(Medication.class, this,
					PathwayMetamodelPackage.PRESCRIPTION__MEDICATION);
		}
		return medication;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PathwayMetamodelPackage.PRESCRIPTION__MEDICATION:
