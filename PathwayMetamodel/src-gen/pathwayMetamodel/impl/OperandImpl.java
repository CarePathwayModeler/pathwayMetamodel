 ...
 * </p>
 * <ul>
 *   <li>{@link pathwayMetamodel.impl.OperandImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperandImpl extends MinimalEObjectImpl.Container implements Operand {
	...
	protected EClass eStaticClass() {
		return PathwayMetamodelPackage.Literals.OPERAND;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathwayMetamodelPackage.OPERAND__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PathwayMetamodelPackage.OPERAND__NAME:
			return getName();
		}
