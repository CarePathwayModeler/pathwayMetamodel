	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Protocolosv2Package.AUXILIARY_CONDUCT: {
				...
				if (result == null) result = caseElement(auxiliaryConduct);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Protocolosv2Package.PRESCRIPTION: {
				...
				if (result == null) result = caseElement(prescription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Protocolosv2Package.DISCHARGE: {
				...
				if (result == null) result = caseElement(discharge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Protocolosv2Package.REFERRAL: {
				...
				if (result == null) result = caseElement(referral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Protocolosv2Package.TREATMENT: {
				...
				if (result == null) result = caseElement(treatment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Protocolosv2Package.INFORMATION: {
				...
				if (result == null) result = caseElement(information);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
