...
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	public EList<Question> getQuestion() {
		if (question == null) {
			question = new EObjectWithInverseResolvingEList<Question>(Question.class, this, Protocolosv2Package.CATEGORY__QUESTION, Protocolosv2Package.QUESTION__CATEGORY);
		}
		return question;
	}
