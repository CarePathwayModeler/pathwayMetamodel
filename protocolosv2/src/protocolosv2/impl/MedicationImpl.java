...
public class MedicationImpl extends MinimalEObjectImpl.Container implements Medication {
	...
	public void setMed_id(int newMed_id) {
		...
		med_id = newMed_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__MED_ID, oldMed_id, med_id));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__DESCRIPTION, oldDescription, description));
	}
	...
	public void setBrand(String newBrand) {
		...
		brand = newBrand;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__BRAND, oldBrand, brand));
	}
	...
	public void setStandardized(boolean newStandardized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__STANDARDIZED, oldStandardized, standardized));
	}
	...
	public void setControlled(boolean newControlled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CONTROLLED, oldControlled, controlled));
	}
	...
	public void setConsigned(boolean newConsigned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CONSIGNED, oldConsigned, consigned));
	}
	...
	public void setCritical(boolean newCritical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CRITICAL, oldCritical, critical));
	}
	...
	public void setInvasive(boolean newInvasive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__INVASIVE, oldInvasive, invasive));
	}
	...
	public void setOutpatient(boolean newOutpatient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__OUTPATIENT, oldOutpatient, outpatient));
	}
	...
	public void setAccess(String newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__ACCESS, oldAccess, access));
	}
	...
	public void setDaily_dosage(int newDaily_dosage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__DAILY_DOSAGE, oldDaily_dosage, daily_dosage));
	}
	...
	public void setCycles(int newCycles) {
		...
		cycles = newCycles;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__CYCLES, oldCycles, cycles));
	}
	...
	public void setTreatement_time(int newTreatement_time) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__TREATEMENT_TIME, oldTreatement_time, treatement_time));
	}
	...
	public void setFrequency(int newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__FREQUENCY, oldFrequency, frequency));
	}
	...
	public void setStandard(String newStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.MEDICATION__STANDARD, oldStandard, standard));
	}
