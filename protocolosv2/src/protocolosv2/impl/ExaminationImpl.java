...
public class ExaminationImpl extends MinimalEObjectImpl.Container implements Examination {
	...
	public void setExam_id(int newExam_id) {
		...
		exam_id = newExam_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__EXAM_ID, oldExam_id, exam_id));
	}
	...
	public void setLimb_side(String newLimb_side) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__LIMB_SIDE, oldLimb_side, limb_side));
	}
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__REASON, oldReason, reason));
	}
	...
	public void setClinical_indication(String newClinical_indication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Protocolosv2Package.EXAMINATION__CLINICAL_INDICATION, oldClinical_indication, clinical_indication));
	}
